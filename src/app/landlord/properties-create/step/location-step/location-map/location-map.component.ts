...
import {TcbDirectiveOutputsOp} from "@angular/compiler-cli/src/ngtsc/typecheck/src/type_check_block";
...
//   country.displayLabel = `${country.flag}   ${country.name.common}`;
// });
...
// });
  ...
  // displayLabel= (country: Country) => country.displayLabel;
